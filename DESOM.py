...
class DESOM:
    ...
    def fit(self,
        ...
        for ite in range(iterations):
            ...
            if ite % eval_interval == 0:
                ...
                if X_val is not None:
                    ...
                    d_original_val = np.square((np.expand_dims(X_val_batch, axis=1) - decoded_prototypes)).sum(axis=2)
                ...
                perflogger.log(batch_summary, verbose=1)
        ...
        print('Evaluate model on training and validation datasets')
        ...
        perflogger.evaluate(final_summary, verbose=1)
        perflogger.close()
